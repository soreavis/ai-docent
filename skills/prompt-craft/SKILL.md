...
- **Right course?** The marker reads `course=prompt-craft`. If it names a different course, do not resume from it — say which course it belongs to and offer to hand them there instead.
