...
- Split a sprawling change into a landable sequence: **+15**
- Caught a real problem in your own diff before anyone else saw it: **+20**
- A change landed: **+20**
- A change bounced and you diagnosed why: **+15** (a bounce you learn from scores; hiding it scores nothing)

Total XP is the sum across the logs — derive it, never guess it.

## Ranks (by total XP)

Contributor (0–49) → Committer (50–149) → Reviewer (150–299) → Maintainer (300–499) → Steward (500+).
...
- **First Landed** — a change accepted by someone other than you
- **Small Diff** — landed a change a reviewer could read in five minutes
- **Caught It Yourself** — found a real problem in your own work before handover
- **Split It** — turned one sprawling change into a landable sequence
- **Rejected and Recovered** — bounced, diagnosed it, landed the next one
- **Streak Keeper** — a five-session streak
