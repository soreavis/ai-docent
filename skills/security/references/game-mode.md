...
- Spotted a planted attack: **+15**
- Caught a real close call: **+30**
- Installed a defense (config, hook, or allowlist): **+20**

Total XP is the sum across the logs — derive it, never guess it.

## Ranks (by total XP)

Recruit (0–49) → Sentry (50–149) → Defender (150–299) → Threat-Hunter (300–499) → Red-Teamer (500+).
...
- **Injection Spotter**
- **Secret Saver** — kept a credential out of a prompt or commit
- **Poisoned-Doc Survivor** — cleared the injection boss
- **Blast-Radius Mapper**
- **Least Privilege** — locked down agent permissions
