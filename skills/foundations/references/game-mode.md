...
- Capstone milestone shipped: **+40**
- Installed a CLAUDE.md or set up their workspace: **+20**

Total XP is the sum across the logs — derive it, never guess it.

## Ranks (by total XP)

Novice (0–49) → Builder (50–149) → Operator (150–299) → Power User (300–499) → Architect (500+).
...
- **First Artifact** — built one
- **Plan Reshaper** — rejected and improved a plan
- **Git Seatbelt** — recovered a runaway session
- **Shipped It** — capstone live
- **No-Hint Boss** — cleared a boss with zero hints
- **Full Five** — every area score ≥ 3
