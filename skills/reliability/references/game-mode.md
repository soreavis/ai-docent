...
- Caught a planted error: **+15**
- Caught a *wild* error out in the real world: **+30**
- Installed a guardrail or honesty config: **+20**

Total XP is the sum across the logs — derive it, never guess it.

## Ranks (by total XP)

Apprentice → Skeptic → Verifier → Auditor → Truth-Keeper.
...
- **First Catch**
- **Hat-Trick** — three catches in one session
- **Wild One** — a real-world catch
- **Clean Sweep** — a boss with every planted error found
- **Grounded** — ran a fully grounded Q&A
