...
- Right-sized a model to a task: **+15**
- Cut a real cost or stayed under budget: **+20**
- Built their operating manual: **+40**

Total XP is the sum across the logs — derive it, never guess it.

## Ranks (by total XP)

Tinkerer (0–49) → Tuner (50–149) → Optimizer (150–299) → Efficiency Engineer (300–499) → Cost Architect (500+).
...
- **Right-Sized** — matched model to task
- **Cache Master**
- **Budget Hawk**
- **Context Trimmer**
- **Operating Manual** — built it
