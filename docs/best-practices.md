...
The single biggest factor. A course built around an actual proposal, an actual repository, an actual rejected pull request produces exercises you'd have had to do anyway. A course built around "something to practise on" produces homework.

If you don't have a real project yet, `foundations` will build one with you. That's what its capstone is for.

## Be accurate about your level
...
## Say when you're lost

The courses adapt on signal, and "I didn't follow that" is the strongest signal you can send. Nodding along produces a plan calibrated to a version of you that doesn't exist.

Same with boredom. If a lesson is beneath you, say it. That's what the retro is for, and you don't have to wait for one.
...
On a filesystem this is automatic. In a chat window it isn't, and the card is the only thing standing between you and starting over.

Copy it somewhere boring and reliable. A note file, a pinned message. Then paste the most recent one when you come back.

## Take the courses in a sensible order
